            ...
            <div class="col-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <strong class="card-title">Hakkımızda Controls</strong>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="./posts/hakkimizda_post.php"  enctype="multipart/form-data" >
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="form-group mb-3">
                                    <img style="width: 10%;" src="./assets/images/images.png" alt="#"> <br>
                                        <label for="example-fileinput">Hakkımızda Resim</label>
                                        <input name="heading_subheading" type="text" placeholder="Hakkımızda Başlık "  id="simpleinput" class="form-control mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                    <textarea name="about_text" placeholder="Açıklama Metni" class="form-control mb-3" id="example-textarea" rows="4"></textarea>
                                    </div>
