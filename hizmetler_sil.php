            ...
            <div class="col-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <strong class="card-title">Hizmetler Sil</strong>
                    </div>
                    <div class="card-body">
                    <form method="POST" action="./posts/hizmetler_sil_post .php" enctype="multipart/form-data" >
    <div class="row">
        <div class="col-md-4"></div>
        <div class="col-md-4">
            <div class="card-body">
                <label for="custom-select">Başlık Seç</label>
                ...
                <button type="submit" class="btn mt-3 btn-success">Sil</button>
            </div>
        </div>
    </div>
</form>
