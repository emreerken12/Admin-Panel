            ...
            <div class="col-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <strong class="card-title">Blog Düzenle</strong>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="./posts/blog_duzenle_post.php"  enctype="multipart/form-data" >
                            <div class="row">
                                <div class="col-md-4">
                ...
                <select class="custom-select" id="custom-select" name="team_member"> <?php
                   ...
                   include ('database.php');
                    $sql = "SELECT title FROM blog_posts_combined";
