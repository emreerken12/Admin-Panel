            ...
            <div class="col-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <strong class="card-title">Slider Controls</strong>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="./posts/slider_post.php"  enctype="multipart/form-data" >
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="form-group mb-3">
                                    <img style="width: 10%;" src="./assets/images/images.png" alt="#"> <br>
                                        <label for="example-fileinput">Slider 1. Resim</label>
                                        <input name="slider1_text" type="text" placeholder="Slider 1. Yazı"  id="simpleinput" class="form-control mb-3">
                                        <input name="slider1_img" type="file"   id="example-fileinput" class="form-control-file">
                                    </div>

                                    <div class="form-group mb-3">
                                    <img style="width: 10%;" src="./assets/images/images.png" alt="#"> <br>
                                        <label for="example-fileinput">Slider 2. Resim</label>
                                        <input name="slider2_text" type="text" placeholder="Slider 2. Yazı"  id="simpleinput" class="form-control mb-3">
                                        <input name="slider2_img" type="file"   id="example-fileinput" class="form-control-file">
                                    </div>
                                    <div class="form-group mb-3">
                                    <img style="width: 10%;" src="./assets/images/images.png" alt="#"> <br>
                                        <label for="example-fileinput">Slider 3. Resim</label>
                                        <input name="slider3_text" type="text" placeholder="Slider 3. Yazı" id="simpleinput" class="form-control mb-3">
                                        <input name=slider3_img type="file"  id="example-fileinput" class="form-control-file">
                                    </div>
